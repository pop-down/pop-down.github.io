// 앱 버전 정보
const APP_VERSION = {
  current: '0.2.6.10',           // 현재 버전
  minRequired: '0.1.0.0',       // 최소 필요 버전
  latest: '0.2.6.10'            // 최신 버전
};
...
const UPDATE_HISTORY = [
  {
    date: '2025-04-19',
    version: '0.2.6.10',
    description: '토글 클릭 버튼 개선'
  },
  {
    date: '2025-04-19',
    version: '0.2.6.9',
    description: '입구/출구 위치 조정 및 지도 viewBox 최적화, 지도 중앙 정렬 및 info-panel 가로폭 넘침 문제 해결'
  },
  {
    date: '2025-04-19',
    version: '0.2.6.7',
